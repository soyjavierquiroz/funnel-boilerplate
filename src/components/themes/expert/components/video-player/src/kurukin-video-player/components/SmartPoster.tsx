...
export function SmartPoster({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgb(var(--color-highlight)/0.25),transparent_45%),linear-gradient(135deg,rgba(9,9,11,0.88),rgba(9,9,11,0.96))]" />
      ...
      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center px-6 text-center text-white">
        ...
        {eyebrow ? <span className="mt-6 text-xs font-semibold uppercase tracking-[0.32em] text-[rgb(var(--color-highlight))]">{eyebrow}</span> : null}
