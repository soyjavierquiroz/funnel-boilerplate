  ...
  return (
    <section className="bg-surface px-4 py-16 sm:px-6">
      <div className="mx-auto max-w-[800px]">
        <div className="relative overflow-hidden rounded-3xl border border-border-subtle/20 bg-surface p-8 shadow-2xl md:p-12">
          <div
          ...
          <div className="mb-10 mt-12">
            <img
              ...
              className="h-auto w-full rounded-2xl border-4 border-surface shadow-lg"
            />
          </div>
