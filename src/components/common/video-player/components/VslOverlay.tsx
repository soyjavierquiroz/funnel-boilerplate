...
export function VslOverlay({ onUnmute }: VslOverlayProps) {
  return (
    <button
      ...
      className="group absolute inset-0 z-50 cursor-pointer bg-[rgba(0,0,0,0.64)] backdrop-blur-[1.5px]"
    >
      <span className="pointer-events-none absolute inset-0 flex items-center justify-center px-4">
        <span className="flex flex-col items-center gap-4 rounded-[20px] border border-white/15 bg-black/55 px-5 py-6 text-center shadow-[0_24px_55px_rgba(0,0,0,0.45)] sm:px-8 sm:py-7">
          ...
          <span className="text-[1.05rem] font-black uppercase leading-tight tracking-[0.04em] text-white sm:text-[1.35rem]">
